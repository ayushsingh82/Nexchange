            ...
            <div className="bg-green-950/40 backdrop-blur-lg p-8 rounded-2xl border border-green-800/50 shadow-2xl">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-green-900/30 p-4 rounded-lg">
                  ...
                  <div className="flex justify-between items-center text-sm mt-2">
                    <span className="text-green-300">Min Stake:</span>
                    <span className="text-green-100">0.1 {selectedToken}</span>
                  </div>
                </div>
            ...
            <div className="bg-green-950/40 backdrop-blur-lg p-8 rounded-2xl border border-green-800/50 shadow-2xl">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-green-900/30 p-4 rounded-lg">
                  ...
                  <div className="flex justify-between items-center text-sm mt-2">
                    <span className="text-green-300">Earned Rewards:</span>
                    <span className="text-green-100">0.00 {selectedToken}</span>
                  </div>
                </div>
