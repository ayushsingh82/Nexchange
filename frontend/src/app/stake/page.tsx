              ...
              <div className="flex items-center justify-center gap-8 mb-6">
                ...
                <div className="relative">
                  <button
                    ...
                    className="bg-green-900/50 border border-green-500/50 text-white px-6 py-4 rounded-xl text-left flex items-center justify-between hover:border-green-400 transition-colors min-w-[200px]"
                  >
                ...
                {/* APY Display */}
                <div className="bg-green-900/30 p-6 rounded-xl border border-green-800/50 min-w-[200px]">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-400 mb-2">
                      {selectedOption?.apy}
                    </div>
                    <div className="text-green-300 text-sm">Annual Percentage Yield</div>
                    <div className="text-green-100 text-lg font-semibold mt-2">{selectedToken}</div>
                  </div>
                </div>
              </div>
            </div>

            {/* Staking and Unstaking UI Side by Side */}
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-4 rounded-lg font-semibold text-lg hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg hover:shadow-green-500/30">
                    Stake {selectedToken}
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white py-4 rounded-lg font-semibold text-lg hover:from-red-600 hover:to-red-700 transition-all shadow-lg hover:shadow-red-500/30">
                    Unstake {selectedToken}
                  </button>
                </div>
              </div>
